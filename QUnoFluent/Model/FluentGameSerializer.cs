// <copyright file="FluentGameSerializer.cs" company="Mooville">
//   Copyright © 2021 Roger Deetz. All rights reserved.
// </copyright>

namespace Mooville.QUno.Fluent.Model
{
    using System;
    ...
    public class FluentGameSerializer : IFluentGameSerializer
    {
        // If this code looks a lot like QUnoUniversal's UniversalGameSerializer, 
        // that is because it is. It has been copied over since Windows App SDK
        // projects use the same Windows Runtime storage APIs.

        public FluentGameSerializer()
        {
        }

        #region IFluentGameSerializer Members
